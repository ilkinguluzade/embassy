...
$(document).ready(function () {
  new ApexCharts(document.querySelector("#bounce-rate"), {
    ...
    series: [{ name: "Bounce Rate (Avg)", data: [25, 60, 20, 90, 45, 100, 45, 100, 55] }],
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#page-views"), {
      chart: { type: "area", height: 80, sparkline: { enabled: !0 } },
      series: [{ name: "Page Views (Avg)", data: [25, 60, 20, 90, 45, 100, 45, 100, 55] }],
      stroke: { width: 1, curve: "smooth" },
      fill: {
        opacity: [0.85, 0.25, 1, 1],
        gradient: {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#site-impressions"), {
      chart: { type: "area", height: 80, sparkline: { enabled: !0 } },
      series: [{ name: "Site Impression (Avg)", data: [25, 60, 20, 90, 45, 100, 45, 100, 55] }],
      stroke: { width: 1, curve: "smooth" },
      fill: {
        opacity: [0.85, 0.25, 1, 1],
        gradient: {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#income-bar-chart"), {
      chart: { type: "bar", height: 120, stacked: !0, toolbar: { show: !1 } },
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { show: !1, style: { colors: "#A0ACBB", fontFamily: "Inter" } },
      },
      yaxis: { labels: { show: !1 } },
      tooltip: {
        y: {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#expense-bar-chart"), {
      ...
      dataLabels: { enabled: !1 },
      stroke: { curve: "smooth" },
      series: [{ name: "Expenses", data: [40, 55, 45, 58, 47, 61, 49, 65, 54, 69, 57, 73] }],
      xaxis: {
        show: !1,
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#revenue-bar-chart"), {
      ...
      dataLabels: { enabled: !1 },
      stroke: { curve: "smooth" },
      series: [{ name: "Pending", data: [40, 55, 45, 58, 47, 61, 49, 65, 54, 69, 57, 73] }],
      xaxis: {
        show: !1,
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#total-comment-color-graph"), {
      ...
      fill: { type: "solid", opacity: 0.4 },
      stroke: { curve: "smooth", width: 3 },
      series: [{ name: "Total Comments", data: [10, 20, 18, 25, 12, 10, 20] }],
      yaxis: { min: 0, max: 30 },
      tooltip: {
        theme: "dark",
        fixed: { enabled: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#total-income-color-graph"), {
      ...
      fill: { type: "solid", opacity: 0.4 },
      stroke: { curve: "smooth", width: 3 },
      series: [{ name: "Income Status", data: [20, 10, 25, 18, 18, 10, 12] }],
      yaxis: { min: 0, max: 30 },
      tooltip: {
        theme: "dark",
        fixed: { enabled: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#total-visitors-color-graph"), {
      ...
      fill: { type: "solid", opacity: 0.4 },
      stroke: { curve: "smooth", width: 3 },
      series: [{ name: "Total Visitors", data: [18, 10, 20, 10, 12, 25, 20] }],
      yaxis: { min: 0, max: 30 },
      tooltip: {
        theme: "dark",
        fixed: { enabled: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#earnings-card-area-chart"), {
      ...
      chart: { type: "area", height: 130, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
      stroke: { width: 2, curve: "smooth" },
      fill: {
        type: "gradient",
        gradient: { shadeIntensity: 1, opacityFrom: 0.2, opacityTo: 0.5, stops: [0, 90, 100] },
      },
      colors: ["#25b865"],
      grid: { show: !1 },
      legend: { show: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#task-completed-area-chart"), {
      series: [{ name: "Task Completed", data: [44, 55, 41, 60, 52, 66, 51] }],
      chart: { type: "area", height: 100, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
      stroke: { width: 0.5, curve: "smooth", dashArray: [2, 2, 2, 2] },
      fill: {
        type: "gradient",
        gradient: { shadeIntensity: 1, opacityFrom: 0.2, opacityTo: 0.75, stops: [0, 90, 100] },
      },
      colors: ["#3454d1"],
      grid: { show: !1 },
      legend: { show: !1 },
      ...
      tooltip: {
        ...
        style: { fontSize: "12px", colors: "#A0ACBB", fontFamily: "Inter" },
      },
    }).render();
  }),
  $(document).ready(function () {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#project-done-area-chart"), {
      series: [{ name: "Project Done", data: [44, 55, 41, 60, 52, 66, 51] }],
      chart: { type: "area", height: 100, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
      stroke: { width: 0.5, curve: "smooth", dashArray: [2, 2, 2, 2] },
      fill: {
        type: "gradient",
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#leads-inquiry-tracking"), {
      chart: { height: 350, width: "100%", stacked: !1, type: "bar", toolbar: { show: !1 } },
      stroke: { show: !1 },
      plotOptions: {
        bar: { endingShape: "rounded", columnWidth: "30%", distributed: !1, dataLabels: { position: "top" } },
      },
      dataLabels: {
        enabled: !0,
        formatter: function (e) {
      ...
      series: [
        { name: "New", data: [20, 30, 40, 50, 46, 42, 38, 34, 30, 28, 26, 25] },
        { name: "Resolved", data: [15, 25, 35, 45, 41, 38, 33, 28, 23, 18, 13, 10] },
      ],
      markers: { size: 0 },
      xaxis: {
        categories: [
      ...
      legend: { show: !1, labels: { fontSize: "12px", colors: "#64748b" }, fontSize: "12px", fontFamily: "Inter" },
    }).render();
  }),
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#leads-inquiry-channel"), {
      chart: { type: "bar", height: 350, stacked: !0, toolbar: { show: !1 } },
      plotOptions: { bar: { endingShape: "rounded", columnWidth: "20%", horizontal: !1 } },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#logged-time-area-chart"), {
      chart: { height: 350, type: "area", stacked: !1, toolbar: { show: !1 } },
      xaxis: {
        categories: [
          "08:30",
          "09:30",
      ...
      series: [{ name: "Time Logged", data: [20, 45, 25, 60, 30, 65, 35, 75, 60, 80, 65, 95], type: "area" }],
      tooltip: {
        y: {
          formatter: function (e) {
            return +e + " Mins";
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#billable-time-bar-chart"), {
      ...
      series: [
        { name: "Total Time", data: [20, 30, 40, 50, 46, 42, 38, 34, 30, 28, 26, 25] },
        { name: "Billable Time", data: [15, 25, 35, 45, 41, 38, 33, 28, 23, 18, 13, 10] },
      ],
      markers: { size: 0 },
      xaxis: {
        categories: [
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#payment-records-chart"), {
      ...
      legend: { show: !1, labels: { fontSize: "12px", colors: "#A0ACBB" }, fontSize: "12px", fontFamily: "Inter" },
    }).render();
  }),
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#leads-overview-donut"), {
      ...
      plotOptions: {
        pie: {
          donut: {
            ...
            labels: {
              show: !1,
              name: { show: !1, fontSize: "16px", colors: "#A0ACBB", fontFamily: "Inter" },
              value: {
                show: !1,
                fontSize: "30px",
                fontFamily: "Inter",
      ...
      responsive: [{ breakpoint: 380, options: { chart: { width: 280 }, legend: { show: !1 } } }],
      tooltip: {
        y: {
          formatter: function (e) {
            return +e + "K";
  ...
  $(document).ready(function () {
    // JSON formatında veri almak için API'yi çağır
    $.get('/dashboard?format=json', function (data) {
        // Gelen veriyi kullanarak kategoriler ve seriler oluştur
        const categories = ["Yan/24", "Fev/24", "Mar/24", "Apr/24", "May/24", "İyn/24", "İyl/24", "Avq/24", "Sen/24", "Okt/24", "Noy/24", "Dek/24"];
        
        // Veri dizilerini başlat
        const totalSeriesData = new Array(12).fill(0);
        const seenSeriesData = new Array(12).fill(0);
        const downloadedSeriesData = new Array(12).fill(0);

        // API'den gelen verileri uygun aylarla eşleştir
        data.totalMessages.forEach(item => {
            totalSeriesData[item._id - 1] = item.count;
        });
        data.seenMessages.forEach(item => {
            seenSeriesData[item._id - 1] = item.count;
        });
        data.downloadedMessages.forEach(item => {
            downloadedSeriesData[item._id - 1] = item.count;
        });

        // ApexCharts grafiğini oluştur
        new ApexCharts(document.querySelector("#messages-monthly-statistics"), {
            chart: { height: 385, type: "area", stacked: !1, toolbar: { show: !1 } },
            xaxis: {
            ...
            legend: { show: !1 },
            colors: ["#3454d1", "#25b865", "#d13b4c"], // Renkler değişmeden kaldı
            dataLabels: { enabled: !1 },
            fill: {
                type: "gradient",
            ...
            series: [
                { name: "Ümumi mesaj sayı", data: totalSeriesData, type: "area" },
                { name: "Görülmüş mesaj sayı", data: seenSeriesData, type: "area" },
                { name: "Yüklənmiş fayl sayı", data: downloadedSeriesData, type: "area" }
            ],
            tooltip: {
                y: {
                    formatter: function (e) {
...
,
  ...
  $(document).ready(function () {
    var e = {
      chart: { height: 352, width: "100%", stacked: !1, type: "bar", toolbar: { show: !1 } },
      stroke: { show: !1 },
      plotOptions: {
        bar: { endingShape: "rounded", columnWidth: "20%", distributed: !0, dataLabels: { position: "top" } },
      },
      dataLabels: {
        enabled: !0,
        formatter: function (e) {
  ...
  $(document).ready(function () {
    var e = {
      ...
      series: [{ name: "Proposal", data: [28, 30, 32, 35, 38, 41, 44, 47, 50, 40, 30, 20] }],
      markers: { size: 0 },
      xaxis: {
        categories: [
          "JAN/23",
    ...
    new ApexCharts(document.querySelector("#proposal-bar-chart"), e).render();
  }),
  $(document).ready(function () {
    var e = {
      chart: { height: 352, width: "100%", stacked: !1, type: "bar", toolbar: { show: !1 } },
      ...
      series: [{ name: "Contract", data: [10, 20, 30, 40, 50, 60, 55, 50, 45, 40, 35, 30] }],
      markers: { size: 0 },
      xaxis: {
        categories: [
          "JAN/23",
    ...
    new ApexCharts(document.querySelector("#contract-bar-chart"), e).render();
  }),
  $(document).ready(function () {
    var e = {
      chart: { height: 352, width: "100%", stacked: !1, type: "bar", toolbar: { show: !1 } },
      ...
      series: [{ name: "Project", data: [10, 20, 30, 40, 50, 60, 65, 50, 45, 40, 35, 30] }],
      markers: { size: 0 },
      xaxis: {
        categories: [
          "JAN/23",
    ...
    new ApexCharts(document.querySelector("#project-bar-chart"), e).render();
  }),
  $(document).ready(function () {
      ...
      plotOptions: {
        pie: {
          donut: {
            ...
            labels: {
              show: !1,
              name: { show: !1, fontSize: "16px", colors: "#64748b", fontFamily: "Inter" },
              value: {
                show: !1,
                fontSize: "30px",
                fontFamily: "Inter",
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#project-statistics-chart"), {
      chart: { height: 365, type: "area", stacked: !1, toolbar: { show: !1 } },
      stroke: { curve: "smooth", width: [1, 1, 1, 1], dashArray: [3, 3, 3, 3], lineCap: "round" },
      xaxis: {
      ...
      fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.3, stops: [0, 100] } },
      series: [
        { name: "Tasks Completed", data: [20, 45, 25, 60, 30, 65, 35], type: "area" },
        { name: "Project Complated", data: [30, 25, 40, 35, 50, 40, 60], type: "area" },
        { name: "Upcomming Project", data: [45, 20, 50, 25, 65, 30, 75], type: "area" },
      ],
      tooltip: {
        y: {
          formatter: function (e) {
  ...
  $(document).ready(function () {
    var e = {
      chart: { height: 320, width: "100%", stacked: !1, type: "bar", toolbar: { show: !1 } },
      stroke: { show: !1 },
      plotOptions: {
        bar: { endingShape: "rounded", columnWidth: "20%", distributed: !0, dataLabels: { position: "top" } },
      },
      ...
      series: [{ name: "Spent", data: [200, 300, 400, 500, 460, 420, 380] }],
      markers: { size: 0 },
      xaxis: {
    ...
    new ApexCharts(document.querySelector("#weekly-time-spent-chart"), e).render();
  }),
  $(document).ready(function () {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#earning-expense-area-chart"), {
      ...
      plotOptions: { bar: { endingShape: "rounded", columnWidth: "15%" } },
      colors: ["#3454D1", "#FFA21D"],
      dataLabels: { enabled: !1 },
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#earnings-area-chart"), {
      series: [{ name: "Earnings", data: [25, 60, 20, 90, 45, 100, 55] }],
      chart: { type: "area", height: 125, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
      stroke: { width: 1, curve: "smooth" },
      fill: {
        type: "gradient",
        gradient: { shadeIntensity: 1, opacityFrom: 0.2, opacityTo: 0.5, stops: [0, 90, 100] },
  ...
  $(document).ready(function () {
    ...
    new ApexCharts(document.querySelector("#performance-overview-candlestick-chart"), e).render();
  });
